      ...
      @capsule.process_tracker.register do
        until inline_executions.empty?
          begin
            ...
            inline_result = inline_execution.perform(id_for_lock: @capsule.process_tracker.id_for_lock)
          ensure
    ...
    def enqueue_at(active_job, timestamp)
      ...
      if will_execute_inline
        result = @capsule.process_tracker.register do
          execution.perform(id_for_lock: @capsule.process_tracker.id_for_lock)
        ensure
